      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-8">
            {[
              { step: 'upload', title: 'Upload', icon: <Upload className="w-5 h-5" /> },
              { step: 'preview', title: 'Preview', icon: <Eye className="w-5 h-5" /> },
              { step: 'processing', title: 'Process', icon: <Settings className="w-5 h-5" /> },
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                ...
                <div className="flex justify-between mt-8 pt-6 border-t">
                  ...
                  <Button onClick={processData} className="bg-blue-600">
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                    ...
                    {exportFormats.map((format) => (
                      <Card 
                        ...
                        className={`cursor-pointer transition-all ${
                          exportFormat === format.id ? 'ring-2 ring-blue-500' : ''
                        }`}
                ...
                <div className="flex justify-between mt-8 pt-6 border-t">
                  ...
                  <Button onClick={downloadFile} className="bg-blue-600">
